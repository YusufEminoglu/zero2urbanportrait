...
- Map-locked or screen-locked portrait masks.
...
- Original renderer restoration and QML export.
...
2. Choose a portrait image.
3. Select road, building, or other vector layers.
4. Use the canvas extent or draw a geographic frame.
5. Choose a preset and smart mask controls.
6. Click **Create portrait** and navigate the map.
